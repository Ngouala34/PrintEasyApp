...
export class AideComponent {
  ...
  // Signal principal pour les FAQs avec état expanded
  faqs = signal<FAQItem[]>([
    {
      id: 1,
  ...
  // Computed pour les FAQs filtrées - CORRECTION ICI
  ...
  // CORRECTION : Toggle sur le signal principal
  ...
  selectCategory(category: string): void {
    ...
    // Pas besoin d'appeler filterFAQs() car computed se met à jour automatiquement
  }
